package com.example.aarya.fieldofficersurveilance.service;
        ...
        public void onLocationChanged(Location location) {
           ...
           /* Toast.makeText(FusedService.this,"loc:" +currentLat + "/ " + currentLng +
            ...
            Call<List<Response>> call = apiService.sendGpsData(currentLat+"", currentLng+"",deviceNum,
                    mProgressStatus+ "", com.example.aarya.fieldofficersurveilance.model.Util.getDateTime(),currentAcc+"","false",
